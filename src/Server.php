		...
		try {
			...
			if (VersionInfo::IS_DEVELOPMENT_BUILD) {
				if (!$this->configGroup->getPropertyBool("settings.enable-dev-builds", false)) {
					...
					$this->logger->emergency($this->language->translate(KnownTranslationFactory::pocketmine_server_devBuild_error5("https://github.com/NetherrackMP/NetherrackMP/releases")));
...
//			}
			...
			$this->logger->info($this->getLanguage()->translate(KnownTranslationFactory::pocketmine_server_info_extended(
				$this->getName(),
