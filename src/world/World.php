...
class World implements ChunkManager
{
	...
	public const WEATHER_CLEAR = 0;
	public const WEATHER_LIGHT_RAIN = 1;
	public const WEATHER_MODERATE_RAIN = 2;
	public const WEATHER_HEAVY_RAIN = 3;
	public const WEATHER_LIGHT_THUNDER = 4;
	public const WEATHER_MODERATE_THUNDER = 5;
	public const WEATHER_HEAVY_THUNDER = 6;
	...
	public function registerGeneratorToWorker(int $worker): void
	{
		...
		$options = $this->provider->getWorldData()->getGeneratorOptions();
		if ($this->generator == OverworldGenerator::class)
			$options = (Server::getInstance()->getConfigGroup()->getPropertyBool("chunk-generation.overworld-negative-y", true) ? "1" : "0") . $options;
		$this->workerPool->submitTaskToWorker(new GeneratorRegisterTask($this, $this->generator, $options), $worker);
